...
import { idlFactory } from './plantify-frontend.did.js';
export { idlFactory } from './plantify-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PLANTIFY_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./plantify-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the plantify-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./plantify-frontend.did.js")._SERVICE>}
 */
export const plantify_frontend = createActor(canisterId);

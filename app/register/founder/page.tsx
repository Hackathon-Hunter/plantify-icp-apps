...
export default function RegisterFounder(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      {/* DarkVeil as background - positioned absolutely to cover entire viewport */}
      <div className="fixed inset-0 z-0">
        <DarkVeil />
      </div>

      {/* Main content wrapper with relative positioning to appear above DarkVeil */}
      <div className="relative z-10">
        <Navbar />

        <section className="flex flex-col gap-4 px-4 sm:px-6 md:px-12 lg:px-24 xl:px-44 2xl:px-24 pt-20 sm:pt-32 md:pt-24 pb-16 md:pb-24 max-w-6xl mx-auto">
              ...
              <div className="bg-neutral-800 p-4 flex flex-col gap-3">
                ...
                {isAuthenticated && !existingFounder && !isCheckingProfile && (
                  <div className="p-3 rounded text-sm flex items-center gap-2 bg-green-900/50 text-green-400 border border-green-700">
                    ...
                    <span>
                      Wallet connected successfully - Ready to register
                    </span>
                  </div>
                )}
                  ...
                  <div className="mt-4 p-3 bg-neutral-900 rounded text-xs">
                    <details>
                      ...
                      <div className="mt-2 text-neutral-300">
                        ...
                        <p>Existing Founder: {existingFounder?.fullName}</p>
                      </div>
                    </details>
                  </div>
                )}

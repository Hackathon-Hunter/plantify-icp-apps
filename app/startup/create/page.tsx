  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-10">
        ...
        <section className="relative flex flex-col gap-4 px-4 sm:px-6 md:px-12 lg:px-24 xl:px-44 2xl:px-0 pt-0 sm:pt-32 md:pt-24 pb-16 md:pb-24 max-w-6xl mx-auto">
          <Breadcrumbs segments={[{ label: "Back to Home" }]} />

          <div className="flex flex-col gap-4">
            <h2 className="text-white text-4xl">Create Your Startup</h2>
            <span>
              Launch your fundraising startup and connect with investors
              worldwide
            </span>
